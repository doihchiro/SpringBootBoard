...
class ArticleServiceTest {
    ...
    void index() {
        // 예상
        Article a = new Article(1L, "아름다워", "창모");
        Article b = new Article(2L, "Day1", "HONNE");
        Article c = new Article(3L, "Butter", "BTS");
    ...
    void show_성공____존재하는_id_입력() {
        // 예상
        Long id = 1L;
        Article expected = new Article(1L, "아름다워", "창모");
